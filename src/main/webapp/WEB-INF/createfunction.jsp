  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
             ...
             <table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td>${f.name }</td>
						<td>${f.description }</td>
						<td><a href="gochangefunction?functionId=${f.id }">详情/修改</a></td>
						<td><a href="deletefunction?functionId=${f.id }">删除</a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
         ...
         <div class="col-md-12">
             <h4>添加功能</h4>
             <form role="form" action="createfunction" method="post">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="备注说明" name="description" required>
				  </div>
